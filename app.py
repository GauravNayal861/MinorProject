...
with st.sidebar:
    ...
    youtube_link = st.text_input(label=":red[Youtube link]", value="", placeholder="")
            ...
            with st.spinner("Running process..."):
                ...
                for segment in segments:
                    ...
                    response = openai.Embedding.create(
                        input=segment["text"].strip(), model="text-embedding-ada-002"
                    )
...
st.markdown(
    "<h1>Youtube GPT 🤖<small> by Anurag , Gaurav ,lakshay and Harsh</a></small></h1>"
...
st.write(
    " You just need to add your API Key and paste it in the 'Chat with the video' tab."
)
